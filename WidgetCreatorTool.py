...
class AppMenu(Frame):
    ...
    def display_menu(self) -> None:
        ...
        # Geometry
        Label(gf.tkinterframe, text='width', image=self.resize_x, compound='right', padx=7, **widget_settings('label')).pack(anchor='w', pady=(4, 0))
        s1 = tesSpinbox(gf.tkinterframe, tags='width', value=200, maxi=600, mini=100, step=10, **widget_settings('spinbox'))
        s1.pack()
        Label(gf.tkinterframe, text='height', image=self.resize_y, compound='right', padx=7, **widget_settings('label')).pack(anchor='w')
        s2 = tesSpinbox(gf.tkinterframe, tags='height', value=44, **widget_settings('spinbox'))
        s2.pack()
        Label(gf.tkinterframe, text='radius', image=self.rotate, compound='right', padx=7, **widget_settings('label')).pack(anchor='w')
        ...
        e1 = tesEntry(bg.tkinterframe, tags='background', text='sea blue', textcolor='white', **widget_settings('spinbox'))
        e1.pack()
        ...
        e2 = tesEntry(bc.tkinterframe, tags='bordercolor', text='black', textcolor='white', **widget_settings('spinbox'))
        e2.pack()
        ...
        e6 = tesEntry(fg.tkinterframe, tags='textposition', text='center', textcolor='white', **widget_settings('spinbox'))
        e6.pack()

        # icon position
        Label(fg.tkinterframe, text='icon position', **widget_settings('label')).pack(padx=7, anchor='w')
        b1 = tesSmallButton(fg.tkinterframe, icon='./icons/pos_leftSmall.png', width=44, height=28, iconposition='center')
        b1.command = lambda pos='w': app.change_icon_position(pos)
        b1.pack(side='left', padx=(7, 0))
        b2 = tesSmallButton(fg.tkinterframe, icon='./icons/pos_centerSmall.png', width=44, height=28, iconposition='center')
        b2.command = lambda pos='center': app.change_icon_position(pos)
        b2.pack(side='left', padx=(6, 0))
        b3 = tesSmallButton(fg.tkinterframe, icon='./icons/pos_rightSmall.png', width=44, height=28, iconposition='center',)
        b3.command = lambda pos='e': app.change_icon_position(pos)
        b3.pack(side='left', padx=(6, 0))
        b4 = tesSmallButton(fg.tkinterframe, width=44, height=28, style='record', radius=10, iconoffset=8, icon='./icons/home2.png')
        b4.command = app.set_icon_activ
        b4.pack(side='left', padx=(7, 0))
